...
.DESCRIPTION
    ...
    az desktopvirtualization hostpool retrieve-registration-token --name $AzHostPoolName --resource-group $AzResourceGroupName
...
.EXAMPLE
    .\az-cli-avd-hostpool-retrieve-registration-token.ps1 -AzHostPoolName "MyHostPool" -AzResourceGroupName "MyResourceGroup"
