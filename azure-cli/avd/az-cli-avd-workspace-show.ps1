...
.DESCRIPTION
    ...
    az desktopvirtualization workspace show --name $AzWorkspaceName --resource-group $AzResourceGroup
...
.EXAMPLE
    .\az-cli-avd-workspace-show.ps1 -AzWorkspaceName "MyWorkspace" -AzResourceGroup "MyResourceGroup"
