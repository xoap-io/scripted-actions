...
.DESCRIPTION
    This script terminates a Windows EC2 instance running NICE DCV using the Remove-EC2Instance cmdlet from AWS.Tools.EC2.
...
[CmdletBinding()]
param(
    [Parameter(Mandatory = $true, HelpMessage = "The EC2 instance ID to terminate (e.g. i-12345678abcdef01).")]
