...
.DESCRIPTION
    This script starts a Windows EC2 instance running NICE DCV using the Start-EC2Instance cmdlet from AWS.Tools.EC2.

.PARAMETER InstanceId
    The EC2 instance ID to start.
...
[CmdletBinding()]
param(
    [Parameter(Mandatory = $true, HelpMessage = "The EC2 instance ID to start (e.g. i-12345678abcdef01).")]
