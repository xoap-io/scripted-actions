...
.DESCRIPTION
    This script uses AWS Systems Manager to run the official NICE DCV installation commands on a Windows EC2 instance using the Send-SSMCommand cmdlet from AWS.Tools.SimpleSystemsManagement.
