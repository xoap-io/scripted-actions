...
.DESCRIPTION
    This script stops EC2 instances using the Stop-EC2Instance cmdlet from AWS.Tools.EC2.
...
[CmdletBinding()]
param(
    [Parameter(Mandatory = $true, HelpMessage = "Array of EC2 instance IDs to stop (e.g. i-12345678abcdef01).")]
