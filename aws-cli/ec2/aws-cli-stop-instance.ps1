...
.DESCRIPTION
    This script robustly stops an EC2 instance, with improved error handling and output.
    Uses aws ec2 stop-instances to perform the operation.
...
[CmdletBinding()]
param(
    [Parameter(Mandatory = $true, HelpMessage = "The ID of the AWS EC2 instance to stop.")]
...
try {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        throw "Failed to stop EC2 instance: $result"
    }
} catch {
