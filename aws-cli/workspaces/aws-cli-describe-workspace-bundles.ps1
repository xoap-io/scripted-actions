...
.LINK
    https://docs.aws.amazon.com/cli/latest/reference/workspaces/describe-workspace-bundles.html
...
try {
    aws workspaces describe-workspace-bundles
    Write-Host "Successfully listed WorkSpace bundles." -ForegroundColor Green
} catch {
