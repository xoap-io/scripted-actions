...
.DESCRIPTION
    This script lists or describes network ACLs using the AWS CLI.
...
.EXAMPLE
    .\aws-cli-describe-network-acls.ps1
...
[CmdletBinding()]
param(
    [Parameter(Mandatory = $false, HelpMessage = "The ID of the network ACL to describe (optional)")]
