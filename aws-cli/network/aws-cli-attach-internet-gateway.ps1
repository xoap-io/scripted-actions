...
[CmdletBinding()]
param(
    [Parameter(Mandatory = $true, HelpMessage = "The ID of the Internet Gateway to attach")]
    [ValidatePattern('^igw-[a-zA-Z0-9]{8,}$')]
    [string]$InternetGatewayId,

    [Parameter(Mandatory = $true, HelpMessage = "The ID of the VPC to attach the Internet Gateway to")]
