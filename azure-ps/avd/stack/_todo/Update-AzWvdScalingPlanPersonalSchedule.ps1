...
.DESCRIPTION
    ...
    Uses the Update-AzWvdScalingPlanPooledSchedule cmdlet from the Az.DesktopVirtualization module.
...
.EXAMPLE
    PS C:\> .\Update-AzWvdScalingPlanPersonalSchedule.ps1 -ResourceGroup "MyResourceGroup" -ScalingPlanName "MyScalingPlan" -ScalingPlanScheduleName "MySchedule"
...
.LINK
    https://learn.microsoft.com/en-us/powershell/module/az.desktopvirtualization/update-azwvdscalingplanpooledschedule?view=azps-12.3.0
...
param (
    ...
    [Parameter(Mandatory=$true, HelpMessage = "The name of the scaling plan schedule to update.")]
    [ValidateNotNullOrEmpty()]
    ...
    [Parameter(Mandatory=$false, HelpMessage = "Specifies when to stop hosts during ramp down.")]
    [ValidateNotNullOrEmpty()]
...
try {
    ...
    # Output the result
    Write-Host "✅ Azure Virtual Desktop Scaling Plan Pooled Schedule updated successfully:" -ForegroundColor Green
    Write-Output $result
