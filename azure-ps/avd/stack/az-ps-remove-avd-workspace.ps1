...
.DESCRIPTION
    ...
    Uses the Remove-AzWvdWorkspace cmdlet from the Az.DesktopVirtualization module.
...
[CmdletBinding()]
param (
    [Parameter(Mandatory=$true, HelpMessage = "The name of the workspace to remove.")]
...
try {
    ...
    # Output the result
    Write-Host "✅ Azure Virtual Desktop Workspace removed successfully:" -ForegroundColor Green
    Write-Output $result
