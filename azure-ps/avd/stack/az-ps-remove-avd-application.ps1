...
.DESCRIPTION
    ...
    Uses the Remove-AzWvdApplication cmdlet from the Az.DesktopVirtualization module.
...
param (
    ...
    [Parameter(Mandatory=$true, HelpMessage = "The name of the application to remove.")]
    [ValidateNotNullOrEmpty()]
    [string]$Name,
