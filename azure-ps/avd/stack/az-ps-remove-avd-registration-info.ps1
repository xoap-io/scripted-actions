...
.DESCRIPTION
    ...
    Uses the Remove-AzWvdRegistrationInfo cmdlet from the Az.DesktopVirtualization module.
...
try {
    ...
    # Output the result
    Write-Host "✅ Registration information removed successfully:" -ForegroundColor Green
    Write-Output $result
